...
public class CitizenFeedback extends javax.swing.JFrame {
    ...
    private void btnSendFeedbackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendFeedbackActionPerformed
          ...
          try
        {
            ...
            String pid = cfb.txtPassportID.getText();
            int id = Integer.parseInt(cfb.txtFeedbackNo.getText());
            String title = cfb.txtFeedbackTitle.getText();
            String department = cfb.cbxDepartment.getSelectedItem().toString();
            String type = cfb.cboxType.getSelectedItem().toString();
            String description = cfb.txtAreaDescription.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitizenFeedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class AdminUnclosedFeedback extends javax.swing.JFrame {
    public static DepartmentMain dm = new DepartmentMain();
    /**
     * Creates new form CitizenViewFeedback
     */
    public AdminUnclosedFeedback() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUnclosedFeedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminUnclosedFeedback().setVisible(true);
            }
        });
    }
